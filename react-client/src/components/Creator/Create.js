      ...
      <div class="container-fluid page-cont">
        ...
        <div class="row dash-row">
          ...
          <div class="col-4 data-box">
            <div>
              <h3>
                ...
                <a href="/Eventcreatshow">
                  Number of your events</a>
              </h3>
            </div>
          </div>
          ...
          <div class="col-4 data-box">
            <div>
              <h3>
                <span>{this.allSeats(this)}</span>
                <a href="/Eventsets">
                  Remaining seats for all events
                </a>
              </h3>
            </div>
          </div>
...
s            </div>
      ...
      <div className="col-md-12">
        ...
        <h4 className="col-sm-3 border p-3 mb-2 bg-primary text-white" id="createClick" onClick={this.appearCreate}>
          Create a new event
        </h4>
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="createEvent">
            <div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  <input className="form-control" placeholder="user name" value={this.state.host} onChange={e => this.setState({host: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                <label className="col-sm-2 col-form-label">Event Name:
                </label>
                <div className="col-sm-10">
                  <input className="form-control" placeholder="event name" value={this.state.event} onChange={e => this.setState({event: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                <label className="col-sm-2 col-form-label">Event Cost:
                </label>
                <div className="col-sm-10">
                  <input className="form-control" placeholder="cost" value={this.state.cost} onChange={e => this.setState({cost: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  <input className="form-control" placeholder="insert a URL" value={this.state.photo} onChange={e => this.setState({photo: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  <input className="form-control" placeholder="available seats number" value={this.state.sets} type="number" onChange={e => this.setState({sets: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                <label className="col-sm-2 col-form-label">
                  Date and time:</label>
                <div className="col-sm-10">
                  <input className="form-control" placeholder="mm/dd/yy" value={this.state.date} type="datetime-local" onChange={e => this.setState({date: e.target.value})}/>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                ...
                <div class="col-sm-8">
                  <input id="location-input" className="form-control" placeholder="city, street" value={this.state.location} onClick={this.modal}/>
                </div>
                <div class="col-sm-2">
                  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Map</button>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  <textarea className="form-control" placeholder="event description" value={this.state.description} onChange={e => this.setState({description: e.target.value})}/>
                </div>
              </div>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div style={{
                ...
                <GoogleMapReact onClick={this.handleClickedMap} bootstrapURLKeys={{
                    key: "AIzaSyD2IjGONmJ7Si4cNEZtNPNgPy5pVEt-_14"
                  }} defaultCenter={this.props.center} defaultIcon={this.props.Marker} defaultZoom={this.props.zoom}>
                  <AnyReactComponent lat={31.95522} lng={35.94503}/>
                </GoogleMapReact>
              </div>
            </div>
